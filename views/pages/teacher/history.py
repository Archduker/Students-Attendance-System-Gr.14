...
class HistoryPage(ctk.CTkFrame):
    ...
    def _create_header(self, parent):
        ...
        ctk.CTkLabel(title_area, text="Review your past attendance records for Data Science modules.", font=("Inter", 12), text_color="#94A3B8").pack(anchor="w")
    ...
    def _create_table_card(self, parent):
        ...
        ctk.CTkLabel(controls, text="📅 Semester 3, 2025", font=("Inter", 12), text_color="#64748B").pack(side="right")

        # Table Header
        headers = ctk.CTkFrame(card, fg_color="#F8FAFC", height=40, corner_radius=0)
        headers.pack(fill="x")
        
        cols = [("COURSE NAME", 3), ("DATE", 2), ("TIME REGISTERED", 2), ("STATUS", 2), ("", 1)]
        ...
        for i, (col, weight) in enumerate(cols):
            ...
            sticky = "w" if i < 3 else "" if i == 3 else "e"  # Empty string instead of 'c'
        ...
        # Mock Data
        self._add_row(self.list_frame, "Probability and Statistics", "15 Dec 2025", "01:50 PM", "PRESENT")
        self._add_row(self.list_frame, "Python Programming Language", "14 Dec 2025", "-", "ABSENT")
        self._add_row(self.list_frame, "Database Management Systems", "13 Dec 2025", "04:23 PM", "LATE")

        # Footer (Pagination)
        footer = ctk.CTkFrame(card, fg_color="transparent")
        footer.pack(fill="x", padx=30, pady=20)
        
        ctk.CTkLabel(footer, text="Showing 3 of 14 records", font=("Inter", 11), text_color="#94A3B8").pack(side="left")
    ...
    def _add_row(self, parent, course, date, time, status):
        ...
        # Status Badge
        status_colors = {
            "PRESENT": ("#DCFCE7", "#22C55E"), # Green
            "ABSENT": ("#FEE2E2", "#EF4444"),  # Red
            "LATE": ("#FEF9C3", "#EAB308")     # Yellow
        }
        ...
        badge.grid(row=0, column=3)  # Removed sticky for center alignment
